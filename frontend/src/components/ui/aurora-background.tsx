...
export const AuroraBackground = ({
  ...
  return (
    <main>
      <div
        className={cn(
          "relative flex flex-col min-h-screen items-center justify-center bg-black dark:bg-black text-white transition-all overflow-hidden",
          className
        )}
        {...props}
      >
        <div className="absolute inset-0 overflow-hidden">
          <div
            ...
            [--aurora:repeating-linear-gradient(100deg,#000000_10%,#18181b_15%,#3f3f46_20%,#a1a1aa_25%,#ffffff_30%)]
